...
{
    public class GetInventoryCategoryByIdQuery : IRequest<InventoryCategoryDto>
    {
        #region param
        public int Id { get; set; }
        #endregion
        public class GetInventoryCategoryByIdHandlerQuery : IRequestHandler<GetInventoryCategoryByIdQuery, InventoryCategoryDto>
        {
            ...
            {
                var inventoryCategory = _unitOfWorkRepository.InventoryCategoryRepository.GetById(request.Id);
